(() => {
  ...
  var require_diff = __commonJS({
    "node_modules/fast-diff/diff.js"(exports, module) {
      ...
      var DIFF_INSERT = 1;
      var DIFF_EQUAL = 0;
      function diff_main(text1, text22, cursor_pos, cleanup, _fix_unicode) {
        if (text1 === text22) {
          if (text1) {
        ...
        if (cursor_pos != null) {
          var editdiff = find_cursor_edit_diff(text1, text22, cursor_pos);
          if (editdiff) {
            return editdiff;
          }
        }
      ...
      function diff_bisectSplit_(text1, text22, x, y) {
      ...
      function diff_commonOverlap_(text1, text22) {
        var text1_length = text1.length;
        var text2_length = text22.length;
        ...
        while (true) {
          ...
          length2 += found;
          if (found == 0 || text1.substring(text_length - length2) == text22.substring(0, length2)) {
            best = length2;
            length2++;
          }
        }
      ...
      function diff_commonSuffix(text1, text22) {
        if (!text1 || !text22 || text1.slice(-1) !== text22.slice(-1)) {
          return 0;
        }
        var pointermin = 0;
        var pointermax = Math.min(text1.length, text22.length);
      ...
      function diff2(text1, text22, cursor_pos, cleanup) {
        return diff_main(text1, text22, cursor_pos, cleanup, true);
      }
...
${reason}`);
  ...
  var svgFilters = freeze2(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]);
  ...
  var svg = freeze2(["accent-height", "accumulate", "additive", "alignment-baseline", "amplitude", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dominant-baseline", "dur", "edgemode", "elevation", "end", "exponent", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "intercept", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "mask-type", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "slope", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "tablevalues", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-orientation", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]);
  var mathMl = freeze2(["accent", "accentunder", "align", "bevelled", "close", "columnalign", "columnlines", "columnspacing", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lquote", "lspace", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]);
  ...
  function createDOMPurify() {
    ...
    let CUSTOM_ELEMENT_HANDLING = Object.seal(create7(null, {
      tagNameCheck: {
        writable: true,
        configurable: false,
        enumerable: true,
    ...
    const EXTRA_ELEMENT_HANDLING = Object.seal(create7(null, {
      tagCheck: {
        writable: true,
        configurable: false,
        enumerable: true,
    ...
    const DEFAULT_MATHML_TEXT_INTEGRATION_POINTS = freeze2(["mi", "mo", "mn", "ms", "mtext"]);
    let MATHML_TEXT_INTEGRATION_POINTS = addToSet({}, DEFAULT_MATHML_TEXT_INTEGRATION_POINTS);
    const DEFAULT_HTML_INTEGRATION_POINTS = freeze2(["annotation-xml"]);
    ...
    const _parseConfig = function _parseConfig2() {
      ...
      const customElementHandling = objectHasOwnProperty(cfg, "CUSTOM_ELEMENT_HANDLING") && cfg.CUSTOM_ELEMENT_HANDLING && typeof cfg.CUSTOM_ELEMENT_HANDLING === "object" ? clone(cfg.CUSTOM_ELEMENT_HANDLING) : create7(null);
      CUSTOM_ELEMENT_HANDLING = create7(null);
  ...
  // docs/scripts/crdt-client.js
  function initCRDT(editorElement, noteId, user, onLogUpdate) {
    ...
    const getCursorIndex = (element2) => {
      ...
      try {
        ...
        const html2 = element2.innerHTML;
        const searchStr = `>${MARKER_SENTINEL}<`;
        const pos = html2.indexOf(searchStr);
        marker.remove();
        if (pos >= 0) {
          const tagStart = html2.lastIndexOf("<", pos);
    ...
    const addSharedLogEntry = (action, text3) => {
      const now = /* @__PURE__ */ new Date();
      const timeStr = `${now.getHours().toString().padStart(2, "0")}:${now.getMinutes().toString().padStart(2, "0")}:${now.getSeconds().toString().padStart(2, "0")}`;
      const displaySafeText = text3.length > 20 ? text3.substring(0, 20) + "..." : text3;
      ydoc.transact(() => {
        yLog.push([{
          user: userName,
          color: userColor,
    ...
    const updateDOMFromYjs = () => {
      ...
      if (currentContent !== newContent) {
        ...
        if (savedRelativeCursor) {
          const absPos = createAbsolutePositionFromRelativePosition(savedRelativeCursor, ydoc);
        ...
        editorElement.innerHTML = purify.sanitize(markedHTML);
    ...
    const syncLocalToRemote = () => {
      ...
      isLocalUpdate = true;
      const changes = (0, import_fast_diff.default)(lastSyncedContent, localContent);
      ydoc.transact(() => {
        let index = 0;
  ...
  // docs/scripts/entry.js
  console.log(`BUNDLE VERSION: ${(/* @__PURE__ */ new Date()).toISOString()}`);
  window.initCRDT = initCRDT;
  window.sanitizeHtml = (html2) => purify.sanitize(html2 || "");
})();
